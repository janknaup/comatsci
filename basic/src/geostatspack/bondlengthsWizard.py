...
# Form implementation generated from reading ui file 'bondlengthsWizard.ui'
#
...
class bondlengthsWizard(QWizard):
    def __init__(self,parent = None,name = None,modal = 0,fl = 0):
        QWizard.__init__(self,parent,name,modal,fl)

        if not name:
            self.setName("bondlengthsWizard")
    ...
    def languageChange(self):
        self.setCaption(self.__tr("Bond Length Distribution","Bin atomic charges into historams per element"))
...
"<p>If the Python Gnuplot package and gnuplot are available, the rdf can be directly plotted and the plot can be saved.</p>"))
        ...
        self.textLabel2.setText(self.__tr("<h1>Bins</h1>\n"
"<p>Total and Z<sub>1</sub>-Z<sub>2</sub> combination wise histograms of bond lengths.</p>\n"
"<p>Select the number of bins for the bond lengths histograms.</p>"))
        self.setTitle(self.page,self.__tr("Binning"))
        self.textLabel4.setText(self.__tr("Data file name"))
        self.dataFileEdit.setText(self.__tr("bondlengthhist.dat"))
...
"<p>This may take a while.</p>"))
    ...
    def __tr(self,s,c = None):
        return qApp.translate("bondlengthsWizard",s,c)
